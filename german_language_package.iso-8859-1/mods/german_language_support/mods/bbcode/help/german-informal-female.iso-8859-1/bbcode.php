...
<html>
  ...
  <body>
    <h2>BBCode-Hilfe</h2>
    <p>
      BBCode ist die Kurzform f&uuml;r Bulletin Board Code. Es ist eine Formatierungssprache, welche von Dir zur Formatierung von Nachrichten verwendet werden kann. Diese Hilfeseite beschreibt die in diesem Forum nutzbaren Formatierungen. Bitte beachte, dass einige der hier beschriebenen Formatierung in diesem Forum eventuell nicht verf&uuml;gbar sind. Der Administrator kann die einzelnen Formatierungen ein- und ausschalten.
    </p>
    <h3>
    ...
    <p>
      Mit diesen Markierungen kannst Du Formatierungen zu Textbl&ouml;cken hinzuf&uuml;gen. Beispiele:
    </p>
    <tt>
    ...
    <p>
      Mit diesen Markierungen kannst Du Text hoch- oder tiefstellen. Das ist zum Beispiel in den folgenden F&auml;llen sinnvoll: &quot;2<sup>4</sup> = 16&quot; oder &quot;H<sub>2</sub>O&quot;.
    </p>
    <p>
      Beispiel:
    </p>
    ...
    <h3>
      ...
      Linksb?ndiger Test: [left]&hellip;[/left]<br />
      Rechtsb?ndiger Text: [right]&hellip;[/right]
    </h3>
    <p>
      Mit diesen Markierungen kannst Du Text auf dem Bildschirm ausrichten. Beispiele:
    </p>
    <tt>
...
|_|    |_| |_|\___/|_|   \__,_|_| |_| |_|
    ...
    <p>
      Wenn Du ein Zitat Deiner Nachricht hinzuf&uuml;gen willst, dann kannst Du diese Markierung nutzen. Dabei kannst Du ausw&auml;hlen, ob Du denjenigen, den Du zitieren m&ouml;chtest, mit angibst oder nicht.
    </p>
    <p>
      Beispiele:
    </p>
    ...
    <p>
      Um eine Trennungslinie einzuf&uuml;gen, kannst Du die [hr]-Markierung nutzen. Das w&uuml;rde dann wie folgt aussehen:
    </p>
    <hr />
    <p>
