...
case 4:
    // Kontakt
    $PHORUM['DATA']['LANG']['Buddies']          = 'Kontaktliste';
    $PHORUM['DATA']['LANG']['Buddy']            = 'Kontakt';
    $PHORUM['DATA']['LANG']['BuddyAdd']         = 'Teilnehmer meiner Kontaktliste hinzufügen';
    $PHORUM['DATA']['LANG']['BuddyAddFail']     = 'Der Teilnehmer konnte nicht Ihrer Kontaktliste hinzugefügt werden.';
    $PHORUM['DATA']['LANG']['BuddyAddSuccess']  = 'Der Teilnehmer wurde Ihrer Kontaktliste hinzugefügt.';
    $PHORUM['DATA']['LANG']['BuddyListIsEmpty'] = 'Ihre Kontaktliste ist leer.<br />Um Teilnehmer hinzuzufügen, öffnen Sie deren Profil und klicken Sie auf &quot;Teilnehmer meiner Kontaktliste hinzufügen&quot;.';
    break;
default:
    // Kontakt
    $PHORUM['DATA']['LANG']['Buddies']          = 'Kontaktliste';
